...
import { Persona as FPersona, PersonaSize, PersonaInitialsColor } from '@fluentui/react/lib/Persona';
...
class Persona extends React.Component {
  ...
  render() {
    ...
    if (this.props.email && this.props?.email?.trim().length > 0) {
      ...
      email = <Link {...this.props} value={this.props.email} linkHref={link ? link : ''} />;
    }
