...
class MetaDataPair extends React.Component {
  ...
  render() {
    ...
    if (!leftW) leftW = defaultLeftWidth;
    ...
    if (this.props.children) {
      ...
      if (childList.length) {
        ...
        for (i = 0; i < childList.length; i++) {
          ...
          let stack = (
            <StackItem grow={false} horizontalAlign={horizontalAlign} verticalAlign={verticalAlign}>
              {child}
            </StackItem>
          );
      ...
      <React.Fragment>
        {
          ...
          >
            <StackItem styles={leftStackItemStyles} disableShrink={true} align={'stretch'}>
