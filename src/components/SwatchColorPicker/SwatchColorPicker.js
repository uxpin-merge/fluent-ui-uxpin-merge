...
class SwatchColorPicker extends React.Component {
  ...
  set() {
    ...
    let palette =
      pref === paletteBlues
        ? UxpColors.getBlueColorList()
        : pref === paletteGreys
        ? UxpColors.getGreyColorList()
        : pref === paletteAccents
        ? UxpColors.getAccentColorList()
        : sampleColorList;
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.palette !== this.props.palette || prevProps.selectedIndex !== this.props.selectedIndex) {
      this.set();
    }
  }
...
SwatchColorPicker.propTypes = {
   ...
   */
  palette: PropTypes.oneOf([paletteBlues, paletteGreys, paletteAccents, paletteCustom]),
