...
class Breadcrumb extends React.Component {
  ...
  set() {
    ...
    UXPinParser.parse(this.props.items).map((item, index) => {
  ...
  render() {
    ...
    let oIndex = overflow < 0 ? 0 : overflow > ceiling ? ceiling : overflow;

    //MaxDisplayItems
    //Floor: 1
    //Ceiling: Any positive value
    let mDisplay = this.props.maxDisplayedItems < 1 ? 1 : this.props.maxDisplayedItems;
