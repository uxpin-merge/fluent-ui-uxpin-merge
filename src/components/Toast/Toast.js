...
const instructionText = `Toast: 
1) Like a Vertical Stack, add child objects. 
2) In the Props Panel or at runtime, show/hide this Toast at top of the page.`;
...
Toast.propTypes = {
    ...
    /**
     * @uxpindescription Whether to display the Toast at the top of the page 
     */
    show: PropTypes.bool,
