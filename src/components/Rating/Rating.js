...
class Rating extends React.Component {
  ...
  set() {
    ...
    let sCount =
      this.props.stars < minNumberOfStars
        ? minNumberOfStars
        : this.props.stars > maxNumberOfStars
        ? maxNumberOfStars
        : this.props.stars;

    let index = this.props.value < 0 ? 0 : this.props.value > sCount ? sCount : this.props.value;
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.value !== this.props.value || prevProps.stars !== this.props.stars) {
      this.set();
    }
  }
