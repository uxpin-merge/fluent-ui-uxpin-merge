...
class Text extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.textValue !== this.props.textValue || prevProps.size !== this.props.size) {
      this.set();
    }
  }
  ...
  render() {
    ...
    return (
      <FText {...this.props} styles={fTextStyles} variant={this.props.size} nowrap={this.props.truncate}>
        {this.state.message}
      </FText>
    );
  }
